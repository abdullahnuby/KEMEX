...
## Reference screenshot reassessment
The supplied reference screens reveal that the correct direction is flatter and more structured than the previous overhaul: `#eef2f6` background, white surfaces, slate borders, compact typography, restrained teal actions, and dashed inner information surfaces. The previous layer was too decorative and retained too many historical visual rules. v0.39.0 adds a final reference layer and restructures the Projects and Asset Detail views accordingly.
