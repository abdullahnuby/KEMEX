    ...
    <div className="space-y-6">
      ...
      <DataTable
        ...
        columns={[
          ...
          { id: 'actions', header: 'إجراءات', hideable: false, searchable: false, render: row => <div className="flex flex-wrap gap-2">{canEdit && <><Button size="sm" variant="ghost" icon={<Pencil size={14} />} onClick={() => openEdit(row)}>تعديل</Button><Button size="sm" variant="danger" icon={<Trash2 size={14} />} onClick={() => void remove(row)}>حذف</Button></>}</div> },
        ]}
      />
